    ...
    _initializeLunoPaths() {
        return {
            ...
            SET_3_ZAR_ALTCOINS: [
                ...
                { id: 'ZAR_ADA_XBT_ZAR', pairs: ['ADAZAR', 'ADAXBT', 'XBTZAR'], sequence: 'ZAR → ADA → XBT → ZAR', steps: [{ pair: 'ADAZAR', side: 'buy' }, { pair: 'ADAXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_ADA_ZAR', pairs: ['XBTZAR', 'ADAXBT', 'ADAZAR'], sequence: 'ZAR → XBT → ADA → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'ADAXBT', side: 'sell' }, { pair: 'ADAZAR', side: 'sell' }] },
                { id: 'ZAR_DOT_XBT_ZAR', pairs: ['DOTZAR', 'DOTXBT', 'XBTZAR'], sequence: 'ZAR → DOT → XBT → ZAR', steps: [{ pair: 'DOTZAR', side: 'buy' }, { pair: 'DOTXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_DOT_ZAR', pairs: ['XBTZAR', 'DOTXBT', 'DOTZAR'], sequence: 'ZAR → XBT → DOT → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'DOTXBT', side: 'sell' }, { pair: 'DOTZAR', side: 'sell' }] },
                { id: 'ZAR_AVAX_XBT_ZAR', pairs: ['AVAXZAR', 'AVAXXBT', 'XBTZAR'], sequence: 'ZAR → AVAX → XBT → ZAR', steps: [{ pair: 'AVAXZAR', side: 'buy' }, { pair: 'AVAXXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_AVAX_ZAR', pairs: ['XBTZAR', 'AVAXXBT', 'AVAXZAR'], sequence: 'ZAR → XBT → AVAX → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'AVAXXBT', side: 'sell' }, { pair: 'AVAXZAR', side: 'sell' }] },
                { id: 'ZAR_LTC_XBT_ZAR', pairs: ['LTCZAR', 'LTCXBT', 'XBTZAR'], sequence: 'ZAR → LTC → XBT → ZAR', steps: [{ pair: 'LTCZAR', side: 'buy' }, { pair: 'LTCXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_LTC_ZAR', pairs: ['XBTZAR', 'LTCXBT', 'LTCZAR'], sequence: 'ZAR → XBT → LTC → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'LTCXBT', side: 'sell' }, { pair: 'LTCZAR', side: 'sell' }] },
                { id: 'ZAR_ALGO_XBT_ZAR', pairs: ['ALGOZAR', 'ALGOXBT', 'XBTZAR'], sequence: 'ZAR → ALGO → XBT → ZAR', steps: [{ pair: 'ALGOZAR', side: 'buy' }, { pair: 'ALGOXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_ALGO_ZAR', pairs: ['XBTZAR', 'ALGOXBT', 'ALGOZAR'], sequence: 'ZAR → XBT → ALGO → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'ALGOXBT', side: 'sell' }, { pair: 'ALGOZAR', side: 'sell' }] },
                { id: 'ZAR_ATOM_XBT_ZAR', pairs: ['ATOMZAR', 'ATOMXBT', 'XBTZAR'], sequence: 'ZAR → ATOM → XBT → ZAR', steps: [{ pair: 'ATOMZAR', side: 'buy' }, { pair: 'ATOMXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_ATOM_ZAR', pairs: ['XBTZAR', 'ATOMXBT', 'ATOMZAR'], sequence: 'ZAR → XBT → ATOM → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'ATOMXBT', side: 'sell' }, { pair: 'ATOMZAR', side: 'sell' }] },
                { id: 'ZAR_CRV_XBT_ZAR', pairs: ['CRVZAR', 'CRVXBT', 'XBTZAR'], sequence: 'ZAR → CRV → XBT → ZAR', steps: [{ pair: 'CRVZAR', side: 'buy' }, { pair: 'CRVXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_CRV_ZAR', pairs: ['XBTZAR', 'CRVXBT', 'CRVZAR'], sequence: 'ZAR → XBT → CRV → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'CRVXBT', side: 'sell' }, { pair: 'CRVZAR', side: 'sell' }] },
                { id: 'ZAR_GRT_XBT_ZAR', pairs: ['GRTZAR', 'GRTXBT', 'XBTZAR'], sequence: 'ZAR → GRT → XBT → ZAR', steps: [{ pair: 'GRTZAR', side: 'buy' }, { pair: 'GRTXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_GRT_ZAR', pairs: ['XBTZAR', 'GRTXBT', 'GRTZAR'], sequence: 'ZAR → XBT → GRT → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'GRTXBT', side: 'sell' }, { pair: 'GRTZAR', side: 'sell' }] },
                { id: 'ZAR_NEAR_XBT_ZAR', pairs: ['NEARZAR', 'NEARXBT', 'XBTZAR'], sequence: 'ZAR → NEAR → XBT → ZAR', steps: [{ pair: 'NEARZAR', side: 'buy' }, { pair: 'NEARXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_NEAR_ZAR', pairs: ['XBTZAR', 'NEARXBT', 'NEARZAR'], sequence: 'ZAR → XBT → NEAR → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'NEARXBT', side: 'sell' }, { pair: 'NEARZAR', side: 'sell' }] },
                { id: 'ZAR_POL_XBT_ZAR', pairs: ['POLZAR', 'POLXBT', 'XBTZAR'], sequence: 'ZAR → POL → XBT → ZAR', steps: [{ pair: 'POLZAR', side: 'buy' }, { pair: 'POLXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_POL_ZAR', pairs: ['XBTZAR', 'POLXBT', 'POLZAR'], sequence: 'ZAR → XBT → POL → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'POLXBT', side: 'sell' }, { pair: 'POLZAR', side: 'sell' }] },
                { id: 'ZAR_SAND_XBT_ZAR', pairs: ['SANDZAR', 'SANDXBT', 'XBTZAR'], sequence: 'ZAR → SAND → XBT → ZAR', steps: [{ pair: 'SANDZAR', side: 'buy' }, { pair: 'SANDXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_SAND_ZAR', pairs: ['XBTZAR', 'SANDXBT', 'SANDZAR'], sequence: 'ZAR → XBT → SAND → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'SANDXBT', side: 'sell' }, { pair: 'SANDZAR', side: 'sell' }] },
                { id: 'ZAR_SNX_XBT_ZAR', pairs: ['SNXZAR', 'SNXXBT', 'XBTZAR'], sequence: 'ZAR → SNX → XBT → ZAR', steps: [{ pair: 'SNXZAR', side: 'buy' }, { pair: 'SNXXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_SNX_ZAR', pairs: ['XBTZAR', 'SNXXBT', 'SNXZAR'], sequence: 'ZAR → XBT → SNX → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'SNXXBT', side: 'sell' }, { pair: 'SNXZAR', side: 'sell' }] },
                { id: 'ZAR_TRX_XBT_ZAR', pairs: ['TRXZAR', 'TRXXBT', 'XBTZAR'], sequence: 'ZAR → TRX → XBT → ZAR', steps: [{ pair: 'TRXZAR', side: 'buy' }, { pair: 'TRXXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_TRX_ZAR', pairs: ['XBTZAR', 'TRXXBT', 'TRXZAR'], sequence: 'ZAR → XBT → TRX → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'TRXXBT', side: 'sell' }, { pair: 'TRXZAR', side: 'sell' }] },
                { id: 'ZAR_XLM_XBT_ZAR', pairs: ['XLMZAR', 'XLMXBT', 'XBTZAR'], sequence: 'ZAR → XLM → XBT → ZAR', steps: [{ pair: 'XLMZAR', side: 'buy' }, { pair: 'XLMXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_XLM_ZAR', pairs: ['XBTZAR', 'XLMXBT', 'XLMZAR'], sequence: 'ZAR → XBT → XLM → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'XLMXBT', side: 'sell' }, { pair: 'XLMZAR', side: 'sell' }] },
                { id: 'ZAR_SONIC_XBT_ZAR', pairs: ['SONICZAR', 'SONICXBT', 'XBTZAR'], sequence: 'ZAR → SONIC → XBT → ZAR', steps: [{ pair: 'SONICZAR', side: 'buy' }, { pair: 'SONICXBT', side: 'buy' }, { pair: 'XBTZAR', side: 'sell' }] },
                { id: 'ZAR_XBT_SONIC_ZAR', pairs: ['XBTZAR', 'SONICXBT', 'SONICZAR'], sequence: 'ZAR → XBT → SONIC → ZAR', steps: [{ pair: 'XBTZAR', side: 'buy' }, { pair: 'SONICXBT', side: 'sell' }, { pair: 'SONICZAR', side: 'sell' }] }
            ]
        };
    }
}
